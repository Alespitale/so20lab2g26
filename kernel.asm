...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 57 78 10 80 	movl   $0x80107857,(%esp)
...
801009fe:	c7 05 94 8f 0b 80 53 	movl   $0x253,0x800b8f94
80100a05:	02 00 00 
  vgainit();
}
80100a08:	83 c4 10             	add    $0x10,%esp
  *(int *)P2V(0xB8F96) = 0x024F;
80100a0b:	c7 05 96 8f 0b 80 4f 	movl   $0x24f,0x800b8f96
80100a12:	02 00 00 
  *(int *)P2V(0xB8F98) = 0x0232;
80100a15:	c7 05 98 8f 0b 80 32 	movl   $0x232,0x800b8f98
80100a1c:	02 00 00 
  *(int *)P2V(0xB8F9A) = 0x0230;
80100a1f:	c7 05 9a 8f 0b 80 30 	movl   $0x230,0x800b8f9a
80100a26:	02 00 00 
  *(int *)P2V(0xB8F9C) = 0x0232;
80100a29:	c7 05 9c 8f 0b 80 32 	movl   $0x232,0x800b8f9c
80100a30:	02 00 00 
  *(int *)P2V(0xB8F9E) = 0x0230;
80100a33:	c7 05 9e 8f 0b 80 30 	movl   $0x230,0x800b8f9e
80100a3a:	02 00 00 
}
80100a3d:	c9                   	leave  
80100a3e:	c3                   	ret    
...
80100a4c:	e8 bf 2d 00 00       	call   80103810 <myproc>
80100a51:	89 85 f4 fe ff ff    	mov    %eax,-0x10c(%ebp)

  begin_op();
80100a57:	e8 74 21 00 00       	call   80102bd0 <begin_op>

  if((ip = namei(path)) == 0){
80100a5c:	83 ec 0c             	sub    $0xc,%esp
80100a5f:	ff 75 08             	pushl  0x8(%ebp)
80100a62:	e8 a9 14 00 00       	call   80101f10 <namei>
80100a67:	83 c4 10             	add    $0x10,%esp
80100a6a:	85 c0                	test   %eax,%eax
80100a6c:	0f 84 91 01 00 00    	je     80100c03 <exec+0x1c3>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
...
80100a75:	89 c3                	mov    %eax,%ebx
80100a77:	50                   	push   %eax
80100a78:	e8 33 0c 00 00       	call   801016b0 <ilock>
  pgdir = 0;

  // Check ELF header
  if(readi(ip, (char*)&elf, 0, sizeof(elf)) != sizeof(elf))
80100a7d:	8d 85 24 ff ff ff    	lea    -0xdc(%ebp),%eax
80100a83:	6a 34                	push   $0x34
80100a85:	6a 00                	push   $0x0
80100a87:	50                   	push   %eax
80100a88:	53                   	push   %ebx
80100a89:	e8 02 0f 00 00       	call   80101990 <readi>
80100a8e:	83 c4 20             	add    $0x20,%esp
80100a91:	83 f8 34             	cmp    $0x34,%eax
80100a94:	74 22                	je     80100ab8 <exec+0x78>
...
80100a99:	53                   	push   %ebx
80100a9a:	e8 a1 0e 00 00       	call   80101940 <iunlockput>
    end_op();
80100a9f:	e8 9c 21 00 00       	call   80102c40 <end_op>
80100aa4:	83 c4 10             	add    $0x10,%esp
  }
  return -1;
80100aa7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80100aac:	8d 65 f4             	lea    -0xc(%ebp),%esp
80100aaf:	5b                   	pop    %ebx
80100ab0:	5e                   	pop    %esi
80100ab1:	5f                   	pop    %edi
80100ab2:	5d                   	pop    %ebp
...
80100ab8:	81 bd 24 ff ff ff 7f 	cmpl   $0x464c457f,-0xdc(%ebp)
80100abf:	45 4c 46 
80100ac2:	75 d2                	jne    80100a96 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100ac4:	e8 77 61 00 00       	call   80106c40 <setupkvm>
80100ac9:	85 c0                	test   %eax,%eax
80100acb:	89 85 f0 fe ff ff    	mov    %eax,-0x110(%ebp)
80100ad1:	74 c3                	je     80100a96 <exec+0x56>
  sz = 0;
80100ad3:	31 ff                	xor    %edi,%edi
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100ad5:	66 83 bd 50 ff ff ff 	cmpw   $0x0,-0xb0(%ebp)
80100adc:	00 
80100add:	8b 85 40 ff ff ff    	mov    -0xc0(%ebp),%eax
80100ae3:	89 85 ec fe ff ff    	mov    %eax,-0x114(%ebp)
80100ae9:	0f 84 8c 02 00 00    	je     80100d7b <exec+0x33b>
80100aef:	31 f6                	xor    %esi,%esi
80100af1:	eb 7f                	jmp    80100b72 <exec+0x132>
80100af3:	90                   	nop
80100af4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ph.type != ELF_PROG_LOAD)
80100af8:	83 bd 04 ff ff ff 01 	cmpl   $0x1,-0xfc(%ebp)
80100aff:	75 63                	jne    80100b64 <exec+0x124>
    if(ph.memsz < ph.filesz)
80100b01:	8b 85 18 ff ff ff    	mov    -0xe8(%ebp),%eax
80100b07:	3b 85 14 ff ff ff    	cmp    -0xec(%ebp),%eax
80100b0d:	0f 82 86 00 00 00    	jb     80100b99 <exec+0x159>
80100b13:	03 85 0c ff ff ff    	add    -0xf4(%ebp),%eax
80100b19:	72 7e                	jb     80100b99 <exec+0x159>
    if((sz = allocuvm(pgdir, sz, ph.vaddr + ph.memsz)) == 0)
80100b1b:	83 ec 04             	sub    $0x4,%esp
80100b1e:	50                   	push   %eax
80100b1f:	57                   	push   %edi
80100b20:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100b26:	e8 35 5f 00 00       	call   80106a60 <allocuvm>
80100b2b:	83 c4 10             	add    $0x10,%esp
80100b2e:	85 c0                	test   %eax,%eax
80100b30:	89 c7                	mov    %eax,%edi
80100b32:	74 65                	je     80100b99 <exec+0x159>
    if(ph.vaddr % PGSIZE != 0)
80100b34:	8b 85 0c ff ff ff    	mov    -0xf4(%ebp),%eax
80100b3a:	a9 ff 0f 00 00       	test   $0xfff,%eax
80100b3f:	75 58                	jne    80100b99 <exec+0x159>
    if(loaduvm(pgdir, (char*)ph.vaddr, ip, ph.off, ph.filesz) < 0)
80100b41:	83 ec 0c             	sub    $0xc,%esp
80100b44:	ff b5 14 ff ff ff    	pushl  -0xec(%ebp)
80100b4a:	ff b5 08 ff ff ff    	pushl  -0xf8(%ebp)
80100b50:	53                   	push   %ebx
80100b51:	50                   	push   %eax
80100b52:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100b58:	e8 43 5e 00 00       	call   801069a0 <loaduvm>
80100b5d:	83 c4 20             	add    $0x20,%esp
80100b60:	85 c0                	test   %eax,%eax
80100b62:	78 35                	js     80100b99 <exec+0x159>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100b64:	0f b7 85 50 ff ff ff 	movzwl -0xb0(%ebp),%eax
80100b6b:	83 c6 01             	add    $0x1,%esi
80100b6e:	39 f0                	cmp    %esi,%eax
80100b70:	7e 3d                	jle    80100baf <exec+0x16f>
    if(readi(ip, (char*)&ph, off, sizeof(ph)) != sizeof(ph))
80100b72:	89 f0                	mov    %esi,%eax
80100b74:	6a 20                	push   $0x20
80100b76:	c1 e0 05             	shl    $0x5,%eax
80100b79:	03 85 ec fe ff ff    	add    -0x114(%ebp),%eax
80100b7f:	50                   	push   %eax
80100b80:	8d 85 04 ff ff ff    	lea    -0xfc(%ebp),%eax
80100b86:	50                   	push   %eax
80100b87:	53                   	push   %ebx
80100b88:	e8 03 0e 00 00       	call   80101990 <readi>
80100b8d:	83 c4 10             	add    $0x10,%esp
80100b90:	83 f8 20             	cmp    $0x20,%eax
80100b93:	0f 84 5f ff ff ff    	je     80100af8 <exec+0xb8>
    freevm(pgdir);
80100b99:	83 ec 0c             	sub    $0xc,%esp
80100b9c:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100ba2:	e8 19 60 00 00       	call   80106bc0 <freevm>
80100ba7:	83 c4 10             	add    $0x10,%esp
80100baa:	e9 e7 fe ff ff       	jmp    80100a96 <exec+0x56>
80100baf:	81 c7 ff 0f 00 00    	add    $0xfff,%edi
80100bb5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
80100bbb:	8d b7 00 20 00 00    	lea    0x2000(%edi),%esi
  iunlockput(ip);
80100bc1:	83 ec 0c             	sub    $0xc,%esp
80100bc4:	53                   	push   %ebx
80100bc5:	e8 76 0d 00 00       	call   80101940 <iunlockput>
  end_op();
80100bca:	e8 71 20 00 00       	call   80102c40 <end_op>
  if((sz = allocuvm(pgdir, sz, sz + 2*PGSIZE)) == 0)
80100bcf:	83 c4 0c             	add    $0xc,%esp
80100bd2:	56                   	push   %esi
80100bd3:	57                   	push   %edi
80100bd4:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100bda:	e8 81 5e 00 00       	call   80106a60 <allocuvm>
80100bdf:	83 c4 10             	add    $0x10,%esp
80100be2:	85 c0                	test   %eax,%eax
80100be4:	89 c6                	mov    %eax,%esi
80100be6:	75 3a                	jne    80100c22 <exec+0x1e2>
    freevm(pgdir);
80100be8:	83 ec 0c             	sub    $0xc,%esp
80100beb:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100bf1:	e8 ca 5f 00 00       	call   80106bc0 <freevm>
80100bf6:	83 c4 10             	add    $0x10,%esp
  return -1;
80100bf9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100bfe:	e9 a9 fe ff ff       	jmp    80100aac <exec+0x6c>
    end_op();
80100c03:	e8 38 20 00 00       	call   80102c40 <end_op>
    cprintf("exec: fail\n");
80100c08:	83 ec 0c             	sub    $0xc,%esp
80100c0b:	68 61 6f 10 80       	push   $0x80106f61
80100c10:	e8 4b fa ff ff       	call   80100660 <cprintf>
    return -1;
80100c15:	83 c4 10             	add    $0x10,%esp
80100c18:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100c1d:	e9 8a fe ff ff       	jmp    80100aac <exec+0x6c>
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c22:	8d 80 00 e0 ff ff    	lea    -0x2000(%eax),%eax
80100c28:	83 ec 08             	sub    $0x8,%esp
  for(argc = 0; argv[argc]; argc++) {
80100c2b:	31 ff                	xor    %edi,%edi
80100c2d:	89 f3                	mov    %esi,%ebx
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c2f:	50                   	push   %eax
80100c30:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100c36:	e8 a5 60 00 00       	call   80106ce0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
80100c3b:	8b 45 0c             	mov    0xc(%ebp),%eax
80100c3e:	83 c4 10             	add    $0x10,%esp
80100c41:	8d 95 58 ff ff ff    	lea    -0xa8(%ebp),%edx
80100c47:	8b 00                	mov    (%eax),%eax
80100c49:	85 c0                	test   %eax,%eax
80100c4b:	74 70                	je     80100cbd <exec+0x27d>
80100c4d:	89 b5 ec fe ff ff    	mov    %esi,-0x114(%ebp)
80100c53:	8b b5 f0 fe ff ff    	mov    -0x110(%ebp),%esi
80100c59:	eb 0a                	jmp    80100c65 <exec+0x225>
80100c5b:	90                   	nop
80100c5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(argc >= MAXARG)
80100c60:	83 ff 20             	cmp    $0x20,%edi
80100c63:	74 83                	je     80100be8 <exec+0x1a8>
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100c65:	83 ec 0c             	sub    $0xc,%esp
80100c68:	50                   	push   %eax
80100c69:	e8 32 3a 00 00       	call   801046a0 <strlen>
...
80100c7c:	e8 1f 3a 00 00       	call   801046a0 <strlen>
...
80100c8d:	e8 ae 61 00 00       	call   80106e40 <copyout>
80100c92:	83 c4 20             	add    $0x20,%esp
80100c95:	85 c0                	test   %eax,%eax
80100c97:	0f 88 4b ff ff ff    	js     80100be8 <exec+0x1a8>
  for(argc = 0; argv[argc]; argc++) {
...
80100cb5:	75 a9                	jne    80100c60 <exec+0x220>
80100cb7:	8b b5 ec fe ff ff    	mov    -0x114(%ebp),%esi
...
80100d23:	75 f1                	jne    80100d16 <exec+0x2d6>
80100d25:	89 55 08             	mov    %edx,0x8(%ebp)
  safestrcpy(curproc->name, last, sizeof(curproc->name));
80100d28:	8b bd f4 fe ff ff    	mov    -0x10c(%ebp),%edi
...
80100d3a:	e8 21 39 00 00       	call   80104660 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d64:	e8 a7 5a 00 00       	call   80106810 <switchuvm>
  freevm(oldpgdir);
80100d69:	89 3c 24             	mov    %edi,(%esp)
80100d6c:	e8 4f 5e 00 00       	call   80106bc0 <freevm>
  return 0;
80100d71:	83 c4 10             	add    $0x10,%esp
80100d74:	31 c0                	xor    %eax,%eax
80100d76:	e9 31 fd ff ff       	jmp    80100aac <exec+0x6c>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100d7b:	be 00 20 00 00       	mov    $0x2000,%esi
80100d80:	e9 3c fe ff ff       	jmp    80100bc1 <exec+0x181>
...
80100d96:	68 6d 6f 10 80       	push   $0x80106f6d
80100d9b:	68 c0 ff 10 80       	push   $0x8010ffc0
80100da0:	e8 8b 34 00 00       	call   80104230 <initlock>
}
...
80100dc1:	e8 aa 35 00 00       	call   80104370 <acquire>
...
80100df1:	e8 3a 36 00 00       	call   80104430 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e2f:	e8 3c 35 00 00       	call   80104370 <acquire>
  if(f->ref < 1)
...
80100e4c:	e8 df 35 00 00       	call   80104430 <release>
  return f;
}
...
80100e5b:	68 74 6f 10 80       	push   $0x80106f74
...
80100e81:	e8 ea 34 00 00       	call   80104370 <acquire>
  if(f->ref < 1)
...
80100eab:	5d                   	pop    %ebp
    release(&ftable.lock);
80100eac:	e9 7f 35 00 00       	jmp    80104430 <release>
...
80100ed5:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100ed8:	e8 53 35 00 00       	call   80104430 <release>
  if(ff.type == FD_PIPE)
...
80100f32:	68 7c 6f 10 80       	push   $0x80106f7c
...
80101012:	68 86 6f 10 80       	push   $0x80106f86
...
80101125:	68 8f 6f 10 80       	push   $0x80106f8f
8010112a:	e8 61 f2 ff ff       	call   80100390 <panic>
  panic("filewrite");
8010112f:	83 ec 0c             	sub    $0xc,%esp
80101132:	68 95 6f 10 80       	push   $0x80106f95
...
801011a3:	68 9f 6f 10 80       	push   $0x80106f9f
...
80101254:	68 b2 6f 10 80       	push   $0x80106fb2
...
80101295:	e8 e6 31 00 00       	call   80104480 <memset>
  log_write(bp);
...
801012da:	e8 91 30 00 00       	call   80104370 <acquire>
...
8010133f:	e8 ec 30 00 00       	call   80104430 <release>
...
8010136a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010136d:	e8 be 30 00 00       	call   80104430 <release>
      return ip;
...
80101382:	68 c8 6f 10 80       	push   $0x80106fc8
...
80101457:	68 d8 6f 10 80       	push   $0x80106fd8
...
80101491:	e8 9a 30 00 00       	call   80104530 <memmove>
  brelse(bp);
...
80101529:	68 58 70 10 80       	push   $0x80107058
...
801015be:	e8 bd 2e 00 00       	call   80104480 <memset>
      dip->type = type;
...
801015f3:	68 f8 6f 10 80       	push   $0x80106ff8
...
80101661:	e8 ca 2e 00 00       	call   80104530 <memmove>
  log_write(bp);
...
8010168f:	e8 dc 2c 00 00       	call   80104370 <acquire>
  ip->ref++;
80101694:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101698:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010169f:	e8 8c 2d 00 00       	call   80104430 <release>
}
...
801016d2:	e8 69 2a 00 00       	call   80104140 <acquiresleep>
  if(ip->valid == 0){
...
80101748:	e8 e3 2d 00 00       	call   80104530 <memmove>
    brelse(bp);
...
8010176d:	68 10 70 10 80       	push   $0x80107010
80101772:	e8 19 ec ff ff       	call   80100390 <panic>
    panic("ilock");
80101777:	83 ec 0c             	sub    $0xc,%esp
8010177a:	68 0a 70 10 80       	push   $0x8010700a
...
801017a3:	e8 38 2a 00 00       	call   801041e0 <holdingsleep>
...
801017be:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017bf:	e9 dc 29 00 00       	jmp    801041a0 <releasesleep>
    panic("iunlock");
801017c4:	83 ec 0c             	sub    $0xc,%esp
801017c7:	68 1f 70 10 80       	push   $0x8010701f
...
801017f0:	e8 4b 29 00 00       	call   80104140 <acquiresleep>
...
8010180a:	e8 91 29 00 00       	call   801041a0 <releasesleep>
  acquire(&icache.lock);
8010180f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101816:	e8 55 2b 00 00       	call   80104370 <acquire>
  ip->ref--;
...
80101a35:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a37:	e8 f4 2a 00 00       	call   80104530 <memmove>
    brelse(bp);
...
80101b33:	e8 f8 29 00 00       	call   80104530 <memmove>
    log_write(bp);
...
80101bce:	e8 cd 29 00 00       	call   801045a0 <strncmp>
}
80101bd3:	c9                   	leave  
80101bd4:	c3                   	ret    
...
80101c2d:	e8 6e 29 00 00       	call   801045a0 <strncmp>
      continue;
...
80101c72:	68 39 70 10 80       	push   $0x80107039
80101c77:	e8 14 e7 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101c7c:	83 ec 0c             	sub    $0xc,%esp
80101c7f:	68 27 70 10 80       	push   $0x80107027
...
80101ca3:	0f 84 67 01 00 00    	je     80101e10 <namex+0x180>
    ...
    ip = idup(myproc()->cwd);
80101ca9:	e8 62 1b 00 00       	call   80103810 <myproc>
  acquire(&icache.lock);
...
80101cb9:	e8 b2 26 00 00       	call   80104370 <acquire>
  ip->ref++;
80101cbe:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cc2:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cc9:	e8 62 27 00 00       	call   80104430 <release>
...
80101d25:	e8 06 28 00 00       	call   80104530 <memmove>
    path++;
...
80101db8:	e8 73 27 00 00       	call   80104530 <memmove>
    name[len] = 0;
...
80101ead:	e8 4e 27 00 00       	call   80104600 <strncpy>
  de.inum = inum;
...
80101eeb:	68 48 70 10 80       	push   $0x80107048
80101ef0:	e8 9b e4 ff ff       	call   80100390 <panic>
    panic("dirlink");
80101ef5:	83 ec 0c             	sub    $0xc,%esp
80101ef8:	68 3e 76 10 80       	push   $0x8010763e
...
8010200b:	68 b4 70 10 80       	push   $0x801070b4
80102010:	e8 7b e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80102015:	83 ec 0c             	sub    $0xc,%esp
80102018:	68 ab 70 10 80       	push   $0x801070ab
...
80102036:	68 c6 70 10 80       	push   $0x801070c6
8010203b:	68 80 a5 10 80       	push   $0x8010a580
80102040:	e8 eb 21 00 00       	call   80104230 <initlock>
...
801020be:	e8 ad 22 00 00       	call   80104370 <acquire>
...
80102121:	e8 3a 1e 00 00       	call   80103f60 <wakeup>
...
8010213f:	e8 ec 22 00 00       	call   80104430 <release>
...
8010215e:	e8 7d 20 00 00       	call   801041e0 <holdingsleep>
...
80102198:	e8 d3 21 00 00       	call   80104370 <acquire>
...
801021e9:	e8 c2 1b 00 00       	call   80103db0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102297:	68 14 71 10 80       	push   $0x80107114
...
801023b8:	e8 b3 1f 00 00       	call   80104370 <acquire>
801023bd:	83 c4 10             	add    $0x10,%esp
801023c0:	eb c2                	jmp    80102384 <kfree+0x44>
    panic("kfree");
801023c2:	83 ec 0c             	sub    $0xc,%esp
801023c5:	68 46 71 10 80       	push   $0x80107146
...
8010242b:	68 4c 71 10 80       	push   $0x8010714c
...
80102523:	e8 48 1e 00 00       	call   80104370 <acquire>
  r = kmem.freelist;
...
80102551:	e8 da 1e 00 00       	call   80104430 <release>
  return (char*)r;
...
801025a3:	0f b6 82 80 72 10 80 	movzbl -0x7fef8d80(%edx),%eax
801025aa:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
801025ac:	0f b6 82 80 71 10 80 	movzbl -0x7fef8e80(%edx),%eax
...
801025c0:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801025c3:	8b 04 85 60 71 10 80 	mov    -0x7fef8ea0(,%eax,4),%eax
...
801025e5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025e8:	0f b6 82 80 72 10 80 	movzbl -0x7fef8d80(%edx),%eax
...
80102967:	e8 64 1b 00 00       	call   801044d0 <memcmp>
...
80102a94:	e8 97 1a 00 00       	call   80104530 <memmove>
...
80102b3a:	68 80 73 10 80       	push   $0x80107380
...
80102bdb:	e8 90 17 00 00       	call   80104370 <acquire>
...
80102c4e:	e8 1d 17 00 00       	call   80104370 <acquire>
  log.outstanding -= 1;
...
80102c8c:	e8 9f 17 00 00       	call   80104430 <release>
}
...
80102ce6:	e8 45 18 00 00       	call   80104530 <memmove>
...
80102d2f:	e8 3c 16 00 00       	call   80104370 <acquire>
    wakeup(&log);
...
80102d42:	00 00 00 
    wakeup(&log);
80102d45:	e8 16 12 00 00       	call   80103f60 <wakeup>
    release(&log.lock);
80102d4a:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d51:	e8 da 16 00 00       	call   80104430 <release>
...
80102d70:	e8 eb 11 00 00       	call   80103f60 <wakeup>
  release(&log.lock);
80102d75:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d7c:	e8 af 16 00 00       	call   80104430 <release>
...
80102d8f:	68 84 73 10 80       	push   $0x80107384
...
80102dde:	e8 8d 15 00 00       	call   80104370 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e2c:	c9                   	leave  
  release(&log.lock);
80102e2d:	e9 fe 15 00 00       	jmp    80104430 <release>
...
80102e59:	68 93 73 10 80       	push   $0x80107393
80102e5e:	e8 2d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e63:	83 ec 0c             	sub    $0xc,%esp
80102e66:	68 a9 73 10 80       	push   $0x801073a9
...
80102e88:	68 c4 73 10 80       	push   $0x801073c4
...
80102eb3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102eb6:	e8 35 39 00 00       	call   801067f0 <switchkvm>
  seginit();
80102ebb:	e8 a0 38 00 00       	call   80106760 <seginit>
  lapicinit();
...
80102f14:	e8 17 2b 00 00       	call   80105a30 <uartinit>
  pinit();         // process table
...
80102f44:	e8 e7 15 00 00       	call   80104530 <memmove>
...
8010301e:	68 d8 73 10 80       	push   $0x801073d8
80103023:	56                   	push   %esi
80103024:	e8 a7 14 00 00       	call   801044d0 <memcmp>
...
801030dc:	68 f5 73 10 80       	push   $0x801073f5
...
80103170:	ff 24 95 1c 74 10 80 	jmp    *-0x7fef8be4(,%edx,4)
...
80103223:	68 dd 73 10 80       	push   $0x801073dd
80103228:	e8 63 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010322d:	83 ec 0c             	sub    $0xc,%esp
80103230:	68 fc 73 10 80       	push   $0x801073fc
...
80103328:	00 00 00 
  initlock(&p->lock, "pipe");
8010332b:	68 30 74 10 80       	push   $0x80107430
...
8010338f:	e8 dc 0f 00 00       	call   80104370 <acquire>
  if(writable){
...
801033d3:	5d                   	pop    %ebp
    release(&p->lock);
801033d4:	e9 57 10 00 00       	jmp    80104430 <release>
...
80103404:	e8 27 10 00 00       	call   80104430 <release>
    kfree((char*)p);
...
8010342d:	e8 3e 0f 00 00       	call   80104370 <acquire>
  for(i = 0; i < n; i++){
...
801034c4:	e8 67 0f 00 00       	call   80104430 <release>
        return -1;
...
8010351b:	e8 10 0f 00 00       	call   80104430 <release>
  return n;
...
80103540:	e8 2b 0e 00 00       	call   80104370 <acquire>
...
801035ae:	e8 7d 0e 00 00       	call   80104430 <release>
      return -1;
...
8010360f:	e8 1c 0e 00 00       	call   80104430 <release>
  return i;
...
80103641:	e8 2a 0d 00 00       	call   80104370 <acquire>
...
80103674:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103677:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
8010367c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103682:	e8 a9 0d 00 00       	call   80104430 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103687:	e8 64 ee ff ff       	call   801024f0 <kalloc>
...
801036a4:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801036a7:	c7 40 14 72 56 10 80 	movl   $0x80105672,0x14(%eax)
  p->context = (struct context*)sp;
...
801036b6:	e8 c5 0d 00 00       	call   80104480 <memset>
...
801036da:	e8 51 0d 00 00       	call   80104430 <release>
}
...
8010370b:	e8 20 0d 00 00       	call   80104430 <release>
...
8010372f:	e8 7c dd ff ff       	call   801014b0 <iinit>
    initlog(ROOTDEV);
...
80103756:	68 35 74 10 80       	push   $0x80107435
8010375b:	68 20 2d 11 80       	push   $0x80112d20
80103760:	e8 cb 0a 00 00       	call   80104230 <initlock>
}
...
80103814:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103817:	e8 84 0a 00 00       	call   801042a0 <pushcli>
  c = mycpu();
8010381c:	e8 4f ff ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103821:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103827:	e8 b4 0a 00 00       	call   801042e0 <popcli>
}
...
80103853:	e8 e8 33 00 00       	call   80106c40 <setupkvm>
...
80103871:	e8 aa 30 00 00       	call   80106920 <inituvm>
...
80103886:	e8 f5 0b 00 00       	call   80104480 <memset>
...
80103923:	68 4c 74 10 80       	push   $0x8010744c
...
80103935:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103938:	e8 63 09 00 00       	call   801042a0 <pushcli>
  c = mycpu();
8010393d:	e8 2e fe ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103942:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103948:	e8 93 09 00 00       	call   801042e0 <popcli>
  if(n > 0){
...
8010395c:	e8 af 2e 00 00       	call   80106810 <switchuvm>
  return 0;
...
8010397a:	e8 e1 30 00 00       	call   80106a60 <allocuvm>
...
8010399a:	e8 f1 31 00 00       	call   80106b90 <deallocuvm>
...
801039b6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039b9:	e8 e2 08 00 00       	call   801042a0 <pushcli>
  c = mycpu();
801039be:	e8 ad fd ff ff       	call   80103770 <mycpu>
  p = c->proc;
801039c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039c9:	e8 12 09 00 00       	call   801042e0 <popcli>
  if((np = allocproc()) == 0){
...
801039e8:	e8 23 33 00 00       	call   80106d10 <copyuvm>
...
80103a2c:	e8 ef d3 ff ff       	call   80100e20 <filedup>
...
80103a49:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103a4c:	e8 2f dc ff ff       	call   80101680 <idup>
...
80103aa5:	e8 96 e8 ff ff       	call   80102340 <kfree>
    np->kstack = 0;
...
80103afe:	e8 6d 08 00 00       	call   80104370 <acquire>
...
80103b20:	e8 eb 2c 00 00       	call   80106810 <switchuvm>
...
80103b32:	e8 84 0b 00 00       	call   801046bb <swtch>
      switchkvm();
80103b37:	e8 b4 2c 00 00       	call   801067f0 <switchkvm>
      c->proc = 0;
...
80103c36:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c39:	e8 62 06 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103c3e:	e8 2d fb ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103c43:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c49:	e8 92 06 00 00       	call   801042e0 <popcli>
  if(curproc == initproc)
...
80103c6a:	e8 01 d2 ff ff       	call   80100e70 <fileclose>
      curproc->ofile[fd] = 0;
...
80103c8a:	e8 51 db ff ff       	call   801017e0 <iput>
  end_op();
...
80103ca2:	e8 c9 06 00 00       	call   80104370 <acquire>
...
80103d3d:	68 bd 74 10 80       	push   $0x801074bd
80103d42:	e8 49 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d47:	83 ec 0c             	sub    $0xc,%esp
80103d4a:	68 b0 74 10 80       	push   $0x801074b0
...
80103d6c:	e8 ff 05 00 00       	call   80104370 <acquire>
  pushcli();
80103d71:	e8 2a 05 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103d76:	e8 f5 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103d7b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d81:	e8 5a 05 00 00       	call   801042e0 <popcli>
...
80103d99:	e8 92 06 00 00       	call   80104430 <release>
}
...
80103dbc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103dbf:	e8 dc 04 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103dc4:	e8 a7 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103dc9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dcf:	e8 0c 05 00 00       	call   801042e0 <popcli>
  if(p == 0)
...
80103df0:	e8 7b 05 00 00       	call   80104370 <acquire>
    release(lk);
80103df5:	89 34 24             	mov    %esi,(%esp)
80103df8:	e8 33 06 00 00       	call   80104430 <release>
  p->chan = chan;
...
80103e1a:	e8 11 06 00 00       	call   80104430 <release>
    acquire(lk);
...
80103e2b:	5d                   	pop    %ebp
    acquire(lk);
80103e2c:	e9 3f 05 00 00       	jmp    80104370 <acquire>
...
80103e59:	68 cf 74 10 80       	push   $0x801074cf
80103e5e:	e8 2d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e63:	83 ec 0c             	sub    $0xc,%esp
80103e66:	68 c9 74 10 80       	push   $0x801074c9
...
80103ef6:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103ef9:	e8 42 e4 ff ff       	call   80102340 <kfree>
        freevm(p->pgdir);
80103efe:	5a                   	pop    %edx
...
80103f02:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f09:	e8 b2 2c 00 00       	call   80106bc0 <freevm>
        release(&ptable.lock);
...
80103f2e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f35:	e8 f6 04 00 00       	call   80104430 <release>
        return pid;
...
80103f53:	e8 d8 04 00 00       	call   80104430 <release>
      return -1;
...
80103f6f:	e8 fc 03 00 00       	call   80104370 <acquire>
...
80103fb0:	c9                   	leave  
  release(&ptable.lock);
80103fb1:	e9 7a 04 00 00       	jmp    80104430 <release>
...
80103fcf:	e8 9c 03 00 00       	call   80104370 <acquire>
...
8010400b:	e8 20 04 00 00       	call   80104430 <release>
      return 0;
...
80104028:	e8 03 04 00 00       	call   80104430 <release>
  return -1;
...
8010407e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104081:	ba e0 74 10 80       	mov    $0x801074e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104086:	77 11                	ja     80104099 <procdump+0x59>
80104088:	8b 14 85 40 75 10 80 	mov    -0x7fef8ac0(,%eax,4),%edx
      state = "???";
8010408f:	b8 e0 74 10 80       	mov    $0x801074e0,%eax
...
801040a1:	68 e4 74 10 80       	push   $0x801074e4
...
801040c8:	e8 83 01 00 00       	call   80104250 <getcallerpcs>
...
801040dd:	68 21 6f 10 80       	push   $0x80106f21
...
8010410a:	68 58 75 10 80       	push   $0x80107558
...
80104165:	e8 46 fc ff ff       	call   80103db0 <sleep>
  while (lk->locked) {
...
80104173:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104179:	e8 92 f6 ff ff       	call   80103810 <myproc>
...
801041c4:	e8 97 fd ff ff       	call   80103f60 <wakeup>
  release(&lk->lk);
...
80104203:	e8 08 f6 ff ff       	call   80103810 <myproc>
...
801042a9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801042aa:	e8 c1 f4 ff ff       	call   80103770 <mycpu>
...
801042bf:	e8 ac f4 ff ff       	call   80103770 <mycpu>
...
8010430c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104310:	e8 5b f4 ff ff       	call   80103770 <mycpu>
...
80104325:	68 63 75 10 80       	push   $0x80107563
8010432a:	e8 61 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010432f:	83 ec 0c             	sub    $0xc,%esp
80104332:	68 7a 75 10 80       	push   $0x8010757a
...
80104358:	e8 13 f4 ff ff       	call   80103770 <mycpu>
...
801043b4:	e8 b7 f3 ff ff       	call   80103770 <mycpu>
...
80104417:	68 81 75 10 80       	push   $0x80107581
...
8010446c:	68 89 75 10 80       	push   $0x80107589
...
80104785:	e8 86 f0 ff ff       	call   80103810 <myproc>
...
80104793:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104796:	e8 75 f0 ff ff       	call   80103810 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801047d8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047db:	e8 30 f0 ff ff       	call   80103810 <myproc>
...
80104874:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104877:	e8 94 ef ff ff       	call   80103810 <myproc>
...
8010488c:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
...
801048b0:	68 91 75 10 80       	push   $0x80107591
...
801048e7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801048ea:	e8 41 d6 ff ff       	call   80101f30 <nameiparent>
...
80104900:	e8 ab cd ff ff       	call   801016b0 <ilock>
...
8010490c:	e8 cf d2 ff ff       	call   80101be0 <dirlookup>
...
8010491e:	e8 1d d0 ff ff       	call   80101940 <iunlockput>
    ilock(ip);
80104923:	89 3c 24             	mov    %edi,(%esp)
80104926:	e8 85 cd ff ff       	call   801016b0 <ilock>
...
8010495a:	e8 e1 cb ff ff       	call   80101540 <ialloc>
...
80104970:	e8 3b cd ff ff       	call   801016b0 <ilock>
  ip->major = major;
...
80104991:	e8 6a cc ff ff       	call   80101600 <iupdate>
...
801049a8:	e8 a3 d4 ff ff       	call   80101e50 <dirlink>
...
801049bc:	e8 7f cf ff ff       	call   80101940 <iunlockput>
  return ip;
...
801049f9:	e8 02 cc ff ff       	call   80101600 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801049fe:	83 c4 0c             	add    $0xc,%esp
80104a01:	ff 77 04             	pushl  0x4(%edi)
80104a04:	68 34 76 10 80       	push   $0x80107634
80104a09:	57                   	push   %edi
80104a0a:	e8 41 d4 ff ff       	call   80101e50 <dirlink>
...
80104a1c:	68 33 76 10 80       	push   $0x80107633
80104a21:	57                   	push   %edi
80104a22:	e8 29 d4 ff ff       	call   80101e50 <dirlink>
...
80104a35:	68 27 76 10 80       	push   $0x80107627
...
80104a4a:	68 36 76 10 80       	push   $0x80107636
80104a4f:	e8 3c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a54:	83 ec 0c             	sub    $0xc,%esp
80104a57:	68 18 76 10 80       	push   $0x80107618
...
80104a94:	e8 77 ed ff ff       	call   80103810 <myproc>
...
80104b02:	e8 19 c3 ff ff       	call   80100e20 <filedup>
  return fd;
...
80104b7d:	e8 0e c4 ff ff       	call   80100f90 <fileread>
...
80104bed:	e8 2e c4 ff ff       	call   80101020 <filewrite>
...
80104c23:	78 2b                	js     80104c50 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c25:	e8 e6 eb ff ff       	call   80103810 <myproc>
...
80104c3b:	e8 30 c2 ff ff       	call   80100e70 <fileclose>
  return 0;
...
80104c94:	e8 a7 c2 ff ff       	call   80100f40 <filestat>
...
80104ce2:	0f 88 e2 00 00 00    	js     80104dca <sys_link+0x11a>
  begin_op();
80104ce8:	e8 e3 de ff ff       	call   80102bd0 <begin_op>
  if((ip = namei(old)) == 0){
80104ced:	83 ec 0c             	sub    $0xc,%esp
80104cf0:	ff 75 d4             	pushl  -0x2c(%ebp)
80104cf3:	e8 18 d2 ff ff       	call   80101f10 <namei>
...
80104d09:	e8 a2 c9 ff ff       	call   801016b0 <ilock>
  if(ip->type == T_DIR){
...
80104d30:	e8 5b ca ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104d35:	58                   	pop    %eax
80104d36:	5a                   	pop    %edx
80104d37:	57                   	push   %edi
80104d38:	ff 75 d0             	pushl  -0x30(%ebp)
80104d3b:	e8 f0 d1 ff ff       	call   80101f30 <nameiparent>
...
80104d4d:	e8 5e c9 ff ff       	call   801016b0 <ilock>
...
80104d63:	e8 e8 d0 ff ff       	call   80101e50 <dirlink>
...
80104d73:	e8 c8 cb ff ff       	call   80101940 <iunlockput>
  iput(ip);
80104d78:	89 1c 24             	mov    %ebx,(%esp)
80104d7b:	e8 60 ca ff ff       	call   801017e0 <iput>
  end_op();
80104d80:	e8 bb de ff ff       	call   80102c40 <end_op>
  return 0;
...
80104d9c:	e8 9f cb ff ff       	call   80101940 <iunlockput>
    goto bad;
80104da1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104da4:	83 ec 0c             	sub    $0xc,%esp
80104da7:	53                   	push   %ebx
80104da8:	e8 03 c9 ff ff       	call   801016b0 <ilock>
  ip->nlink--;
80104dad:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104db2:	89 1c 24             	mov    %ebx,(%esp)
80104db5:	e8 46 c8 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
80104dba:	89 1c 24             	mov    %ebx,(%esp)
80104dbd:	e8 7e cb ff ff       	call   80101940 <iunlockput>
  end_op();
80104dc2:	e8 79 de ff ff       	call   80102c40 <end_op>
  return -1;
...
80104ddb:	e8 60 cb ff ff       	call   80101940 <iunlockput>
    end_op();
80104de0:	e8 5b de ff ff       	call   80102c40 <end_op>
    return -1;
80104de5:	83 c4 10             	add    $0x10,%esp
80104de8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ded:	eb 9b                	jmp    80104d8a <sys_link+0xda>
    end_op();
80104def:	e8 4c de ff ff       	call   80102c40 <end_op>
    return -1;
...
80104e1f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104e22:	e8 a9 dd ff ff       	call   80102bd0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104e27:	83 ec 08             	sub    $0x8,%esp
80104e2a:	53                   	push   %ebx
80104e2b:	ff 75 c0             	pushl  -0x40(%ebp)
80104e2e:	e8 fd d0 ff ff       	call   80101f30 <nameiparent>
...
80104e44:	e8 67 c8 ff ff       	call   801016b0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104e49:	58                   	pop    %eax
80104e4a:	5a                   	pop    %edx
80104e4b:	68 34 76 10 80       	push   $0x80107634
80104e50:	53                   	push   %ebx
80104e51:	e8 6a cd ff ff       	call   80101bc0 <namecmp>
...
80104e64:	68 33 76 10 80       	push   $0x80107633
80104e69:	53                   	push   %ebx
80104e6a:	e8 51 cd ff ff       	call   80101bc0 <namecmp>
...
80104e83:	e8 58 cd ff ff       	call   80101be0 <dirlookup>
...
80104ecd:	e8 be cb ff ff       	call   80101a90 <writei>
...
80104eed:	e8 4e ca ff ff       	call   80101940 <iunlockput>
  ip->nlink--;
80104ef2:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104ef7:	89 1c 24             	mov    %ebx,(%esp)
80104efa:	e8 01 c7 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
80104eff:	89 1c 24             	mov    %ebx,(%esp)
80104f02:	e8 39 ca ff ff       	call   80101940 <iunlockput>
  end_op();
80104f07:	e8 34 dd ff ff       	call   80102c40 <end_op>
  return 0;
...
80104f44:	e8 47 ca ff ff       	call   80101990 <readi>
...
80104f5c:	e8 df c9 ff ff       	call   80101940 <iunlockput>
    goto bad;
80104f61:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
80104f64:	83 ec 0c             	sub    $0xc,%esp
80104f67:	56                   	push   %esi
80104f68:	e8 d3 c9 ff ff       	call   80101940 <iunlockput>
  end_op();
80104f6d:	e8 ce dc ff ff       	call   80102c40 <end_op>
  return -1;
...
80104f89:	e8 72 c6 ff ff       	call   80101600 <iupdate>
...
80104f9b:	e9 71 ff ff ff       	jmp    80104f11 <sys_unlink+0x111>
    end_op();
80104fa0:	e8 9b dc ff ff       	call   80102c40 <end_op>
    return -1;
...
80105012:	0f 88 04 01 00 00    	js     8010511c <sys_open+0x13c>
  ...
  begin_op();
80105018:	e8 b3 db ff ff       	call   80102bd0 <begin_op>
...
8010502d:	e8 de ce ff ff       	call   80101f10 <namei>
...
80105043:	e8 68 c6 ff ff       	call   801016b0 <ilock>
...
80105056:	e8 55 bd ff ff       	call   80100db0 <filealloc>
...
8010508c:	e8 ff c6 ff ff       	call   80101790 <iunlock>
  end_op();
80105091:	e8 aa db ff ff       	call   80102c40 <end_op>
...
801050eb:	0f 85 65 ff ff ff    	jne    80105056 <sys_open+0x76>
      end_op();
801050f1:	e8 4a db ff ff       	call   80102c40 <end_op>
      return -1;
...
8010510f:	e8 2c c8 ff ff       	call   80101940 <iunlockput>
    end_op();
80105114:	e8 27 db ff ff       	call   80102c40 <end_op>
    return -1;
...
8010512c:	e8 3f bd ff ff       	call   80100e70 <fileclose>
...
80105143:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105146:	e8 85 da ff ff       	call   80102bd0 <begin_op>
...
8010517f:	e8 bc c7 ff ff       	call   80101940 <iunlockput>
  end_op();
80105184:	e8 b7 da ff ff       	call   80102c40 <end_op>
  return 0;
...
8010520e:	e8 2d c7 ff ff       	call   80101940 <iunlockput>
  end_op();
80105213:	e8 28 da ff ff       	call   80102c40 <end_op>
  return 0;
...
8010521f:	90                   	nop
    end_op();
80105220:	e8 1b da ff ff       	call   80102c40 <end_op>
    return -1;
...
80105235:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105238:	e8 d3 e5 ff ff       	call   80103810 <myproc>
8010523d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010523f:	e8 8c d9 ff ff       	call   80102bd0 <begin_op>
...
8010525f:	e8 ac cc ff ff       	call   80101f10 <namei>
...
80105284:	e8 07 c5 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105289:	58                   	pop    %eax
8010528a:	ff 76 68             	pushl  0x68(%esi)
8010528d:	e8 4e c5 ff ff       	call   801017e0 <iput>
  end_op();
80105292:	e8 a9 d9 ff ff       	call   80102c40 <end_op>
  curproc->cwd = ip;
...
801052b4:	e8 87 c6 ff ff       	call   80101940 <iunlockput>
    end_op();
801052b9:	e8 82 d9 ff ff       	call   80102c40 <end_op>
    return -1;
...
801052c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801052d0:	e8 6b d9 ff ff       	call   80102c40 <end_op>
    return -1;
...
801053bb:	e8 80 b6 ff ff       	call   80100a40 <exec>
...
801053fc:	e8 6f de ff ff       	call   80103270 <pipealloc>
...
8010540f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105411:	e8 fa e3 ff ff       	call   80103810 <myproc>
...
80105437:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010543a:	e8 d1 e3 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105471:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105478:	e8 93 e3 ff ff       	call   80103810 <myproc>
...
8010548e:	e8 dd b9 ff ff       	call   80100e70 <fileclose>
    fileclose(wf);
80105493:	58                   	pop    %eax
80105494:	ff 75 e4             	pushl  -0x1c(%ebp)
80105497:	e8 d4 b9 ff ff       	call   80100e70 <fileclose>
    return -1;
...
801054b3:	5d                   	pop    %ebp
  return fork();
801054b4:	e9 f7 e4 ff ff       	jmp    801039b0 <fork>
...
801054c3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054c6:	e8 65 e7 ff ff       	call   80103c30 <exit>
...
801054d3:	5d                   	pop    %ebp
  return wait();
801054d4:	e9 97 e9 ff ff       	jmp    80103e70 <wait>
...
801054fe:	e8 bd ea ff ff       	call   80103fc0 <kill>
...
80105523:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105526:	e8 e5 e2 ff ff       	call   80103810 <myproc>
...
80105547:	78 27                	js     80105570 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105549:	e8 c2 e2 ff ff       	call   80103810 <myproc>
  if(growproc(n) < 0)
...
80105556:	e8 d5 e3 ff ff       	call   80103930 <growproc>
...
801055cd:	e8 de e7 ff ff       	call   80103db0 <sleep>
  while(ticks - ticks0 < n){
...
801056ce:	00 00 ef 
  initlock(&tickslock, "time");
801056d1:	68 79 76 10 80       	push   $0x80107679
...
80105750:	ff 24 85 20 77 10 80 	jmp    *-0x7fef88e0(,%eax,4)
...
80105760:	e8 ab e0 ff ff       	call   80103810 <myproc>
...
80105780:	e8 6b e0 ff ff       	call   801037f0 <cpuid>
...
80105791:	e8 7a e0 ff ff       	call   80103810 <myproc>
...
801057b5:	68 dc 76 10 80       	push   $0x801076dc
...
801057d7:	e8 34 e0 ff ff       	call   80103810 <myproc>
...
801057fd:	e8 0e e0 ff ff       	call   80103810 <myproc>
...
80105806:	74 68                	je     80105870 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105808:	e8 03 e0 ff ff       	call   80103810 <myproc>
8010580d:	85 c0                	test   %eax,%eax
8010580f:	74 19                	je     8010582a <trap+0xfa>
80105811:	e8 fa df ff ff       	call   80103810 <myproc>
...
80105832:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105838:	e8 d3 df ff ff       	call   80103810 <myproc>
8010583d:	8b 58 24             	mov    0x24(%eax),%ebx
80105840:	85 db                	test   %ebx,%ebx
80105842:	0f 85 e8 00 00 00    	jne    80105930 <trap+0x200>
    myproc()->tf = tf;
80105848:	e8 c3 df ff ff       	call   80103810 <myproc>
8010584d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105850:	e8 1b f0 ff ff       	call   80104870 <syscall>
    if(myproc()->killed)
80105855:	e8 b6 df ff ff       	call   80103810 <myproc>
...
801058a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801058a8:	e8 93 cd ff ff       	call   80102640 <kbdintr>
    lapiceoi();
801058ad:	e8 ce ce ff ff       	call   80102780 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058b2:	e8 59 df ff ff       	call   80103810 <myproc>
...
801058c8:	e8 53 02 00 00       	call   80105b20 <uartintr>
    lapiceoi();
801058cd:	e8 ae ce ff ff       	call   80102780 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058d2:	e8 39 df ff ff       	call   80103810 <myproc>
...
801058ef:	e8 fc de ff ff       	call   801037f0 <cpuid>
801058f4:	56                   	push   %esi
801058f5:	53                   	push   %ebx
801058f6:	50                   	push   %eax
801058f7:	68 84 76 10 80       	push   $0x80107684
801058fc:	e8 5f ad ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105901:	e8 7a ce ff ff       	call   80102780 <lapiceoi>
    break;
...
80105964:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
8010596b:	e8 f0 e5 ff ff       	call   80103f60 <wakeup>
      release(&tickslock);
...
80105984:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105987:	e8 64 de ff ff       	call   801037f0 <cpuid>
...
80105995:	68 a8 76 10 80       	push   $0x801076a8
8010599a:	e8 c1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
8010599f:	83 c4 14             	add    $0x14,%esp
801059a2:	68 7e 76 10 80       	push   $0x8010767e
...
80105a05:	e8 96 cd ff ff       	call   801027a0 <microdelay>
...
80105a9c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105a9f:	bb a0 77 10 80       	mov    $0x801077a0,%ebx
  ioapicenable(IRQ_COM1, 0);
80105aa4:	6a 00                	push   $0x0
80105aa6:	6a 04                	push   $0x4
80105aa8:	e8 53 c8 ff ff       	call   80102300 <ioapicenable>
...
801065f4:	e8 f7 be ff ff       	call   801024f0 <kalloc>
...
801066ad:	68 a8 77 10 80       	push   $0x801077a8
...
80106704:	e8 37 bc ff ff       	call   80102340 <kfree>
      *pte = 0;
...
80106763:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106766:	e8 85 d0 ff ff       	call   801037f0 <cpuid>
...
80106834:	0f 84 c2 00 00 00    	je     801068fc <switchuvm+0xec>
  pushcli();
8010683a:	e8 61 da ff ff       	call   801042a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010683f:	e8 2c cf ff ff       	call   80103770 <mycpu>
80106844:	89 c6                	mov    %eax,%esi
80106846:	e8 25 cf ff ff       	call   80103770 <mycpu>
8010684b:	89 c7                	mov    %eax,%edi
8010684d:	e8 1e cf ff ff       	call   80103770 <mycpu>
80106852:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106855:	83 c7 08             	add    $0x8,%edi
80106858:	e8 13 cf ff ff       	call   80103770 <mycpu>
...
801068a1:	e8 ca ce ff ff       	call   80103770 <mycpu>
...
801068b9:	e8 b2 ce ff ff       	call   80103770 <mycpu>
801068be:	81 c6 00 10 00 00    	add    $0x1000,%esi
801068c4:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801068c7:	e8 a4 ce ff ff       	call   80103770 <mycpu>
...
8010693b:	77 49                	ja     80106986 <inituvm+0x66>
  mem = kalloc();
8010693d:	e8 ae bb ff ff       	call   801024f0 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010694f:	e8 2c db ff ff       	call   80104480 <memset>
...
80106980:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106981:	e9 aa db ff ff       	jmp    80104530 <memmove>
    panic("inituvm: more than a page");
80106986:	83 ec 0c             	sub    $0xc,%esp
80106989:	68 ed 77 10 80       	push   $0x801077ed
...
80106a11:	e8 7a af ff ff       	call   80101990 <readi>
...
80106aab:	e8 d0 d9 ff ff       	call   80104480 <memset>
...
80106ad9:	0f 86 81 00 00 00    	jbe    80106b60 <allocuvm+0x100>
    mem = kalloc();
80106adf:	e8 0c ba ff ff       	call   801024f0 <kalloc>
    if(mem == 0){
...
80106aed:	68 25 78 10 80       	push   $0x80107825
...
80106b23:	68 3d 78 10 80       	push   $0x8010783d
...
80106b4b:	e8 f0 b7 ff ff       	call   80102340 <kfree>
      return 0;
...
80106c0e:	e8 2d b7 ff ff       	call   80102340 <kfree>
...
80106c23:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106c24:	e9 17 b7 ff ff       	jmp    80102340 <kfree>
    panic("freevm: no pgdir");
...
80106c45:	e8 a6 b8 ff ff       	call   801024f0 <kalloc>
...
80106c60:	e8 1b d8 ff ff       	call   80104480 <memset>
...
80106d50:	e8 db d7 ff ff       	call   80104530 <memmove>
...
80106da5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106da8:	e8 43 b7 ff ff       	call   801024f0 <kalloc>
...
80106e7f:	e8 ac d6 ff ff       	call   80104530 <memmove>
    len -= n;
    buf += n;
